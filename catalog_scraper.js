...
function scrapeMajorDataFromCatalog(link) {
    var options = {
        uri: link,
    ...
    rp(options)
        .then(function ($) {
            ...
            console.log(parseMajorData(major));
        })
        .catch(function (err) {
            console.log(err)
        });
...
scrapeMajorDataFromCatalog('http://catalog.northeastern.edu/archive/2018-2019/undergraduate/computer-information-science/computer-science/bscs/#programrequirementstext')